...
/*
 * Фид для гугл-мерчанта
 * Выборка осуществляется только по московскому складу и для категории Масло сибирского кедра
 */
...
use Native\App\Provider\GoogleMerchant;
...
try {
	...
	GoogleMerchant::export($arParams);
}
