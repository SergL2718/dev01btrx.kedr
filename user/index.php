...
?><? $APPLICATION->IncludeComponent("bitrix:sale.personal.section", "megre", Array(
	"ACCOUNT_PAYMENT_ELIMINATED_PAY_SYSTEMS" => array(
		...
		"PATH_TO_CONTACT" => "/company/contacts",	// Путь к странице контактных данных
		...
		"PROP_3" => "",	// Не показывать свойства для типа плательщика "Физическое лицо" (zg)
		"PROP_4" => "",	// Не показывать свойства для типа плательщика "Юридическое лицо" (zg)
