		...
		if (this.showSkuProps && !!this.obSkuProps)
		{
			...
			else
			{
                ...
                if (this.offers[index].NAME !== '') {
                    $('#' + this.visual.NAME).find('a').html(this.offers[index].NAME);
                    $('#' + this.visual.NAME).find('a').attr('title', this.offers[index].NAME);
                }
                ...
                if (useSkuLinks == "Y") {
                    $('#'+this.visual.NAME).find('a').attr('href', this.offers[index].BASKET_VALUES.LINK);
