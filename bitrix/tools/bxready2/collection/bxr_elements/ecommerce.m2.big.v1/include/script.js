if (window) {
    window.bxrM2EcommerceBigV1 = {
        resizeVerticalBlock: function(isLazy){
            ...
            //clear last settings
            $('.bxr-big-ecommerce-v1[data-resize=1]').each(function() {
            ...
            $('.bxr-big-ecommerce-v1[data-resize=1]').each(function(){
                uid = $(this).data('uid');
                cardCnt = $(this).closest('.row').find('.bxr-big-ecommerce-v1[data-uid=' + uid + ']').length;

                if ($(this).data('resize') == 2 && isLazy != "true" || cardCnt == 1)
                    return;
        ...
        setHoverTop: function(isLazy) {
            $('.bxr-big-ecommerce-v1').each(function(){
                if ($(this).data('resize') == 2 && isLazy != "true")
                    return;
        ...
        setMobileClasses: function() {
            if (jQuery.browser.mobile) {
                $('.bxr-big-ecommerce-v1 .bxr-element-container .bxr-indicator-item-compare').addClass('always-show');
                $('.bxr-big-ecommerce-v1 .bxr-element-container .bxr-indicator-item-favor').addClass('always-show');
            }
        },

        init: function(isLazy) {
            bxrM2EcommerceBigV1.resizeVerticalBlock(isLazy);
            bxrM2EcommerceBigV1.setHoverTop(isLazy);
            bxrM2EcommerceBigV1.setMobileClasses();
            $("img.lazy").lazyload();
        },
    };
    ...
    $(window).on("load", function () {
        bxrM2EcommerceBigV1.init();
    });

    $(document).on("mouseover", ".bxr-big-ecommerce-v1", function () {
    ...
    $(document).on("mouseout", ".bxr-big-ecommerce-v1", function () {
        dots = $(this).find('.slick-dots');
    ...
    window.JCCatalogECommerceBig = function (arParams)
    {
        this.productType = 0;
...
//                            }
    ...
    window.JCCatalogECommerceBig.prototype.Init = function ()
    {
        var i = 0,
                strPrefix = '',
                TreeItems = null;
        ...
        $('#'+ this.visual.PICT_SLIDER_ID).slick({
            ...
            lazyLoad: 'ondemand',
            fade: true,
            asNavFor: '#' + this.visual.PICT_SLIDER_ID +'_container',
            focusOnSelect: true
        });
        switch (this.productType)
        {
...
//                            BX.bind(this.obProduct.parentNode, 'mouseout', BX.delegate(this.clearHeight, this));
    ...
    window.JCCatalogECommerceBig.prototype.SelectOfferProp = function ()
    {
        var i = 0,
                value = '',
                strTreeValue = '',
    ...
    window.JCCatalogECommerceBig.prototype.SearchOfferPropIndex = function (strPropID, strPropValue)
    {
        var strName = '',
                arShowValues = false,
                i, j,
    ...
    window.JCCatalogECommerceBig.prototype.RowLeft = function ()
    {
        var i = 0,
                strTreeValue = '',
                index = -1,
    ...
    window.JCCatalogECommerceBig.prototype.RowRight = function ()
    {
        var i = 0,
                strTreeValue = '',
                index = -1,
    ...
    window.JCCatalogECommerceBig.prototype.UpdateRow = function (intNumber, activeID, showID, canBuyID)
    {
        var i = 0,
                showI = 0,
                value = '',
...
//                                            width: (extShowMode ? 20*countShow : 100)+'%',
    ...
    window.JCCatalogECommerceBig.prototype.GetRowValues = function (arFilter, index)
    {
        var i = 0,
                j,
                arValues = [],
    ...
    window.JCCatalogECommerceBig.prototype.GetCanBuy = function (arFilter)
    {
        var i = 0,
                j,
                boolSearch = false,
    ...
    window.JCCatalogECommerceBig.prototype.SetCurrent = function ()
    {
        var i = 0,
                j = 0,
                arCanBuyValues = [],
    ...
    window.JCCatalogECommerceBig.prototype.ChangeInfo = function ()
    {
        var i = 0,
                j,
                index = -1,
    ...
    window.JCCatalogECommerceBig.prototype.setAnalyticsDataLayer = function (action)
    {
