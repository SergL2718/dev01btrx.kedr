...
?>
<div class="bxr-ecommerce-m2-list-v2" data-uid="<?=$UID?>" data-resize="1" id="<?=$arItemIDs["ID"]?>">
    <table class="bxr-element-container">
        <tr>
            ...
            <tr class="bxr-element-mobile-bottom hidden-xl hidden-lg hidden-md">
                <td colspan="2">
                    <? include('block_templates/price_mobile.php');?>
                    <? include('block_templates/buttons_mobile.php');?>
                    <? include('block_templates/action_timer_mobile.php');?>
                </td>
            </tr>
        </tr>
