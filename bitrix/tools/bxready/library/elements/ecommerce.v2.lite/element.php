	...
	<div class="bxr-ecommerce-v2-lite" data-uid="<?= $UID ?>" data-resize="1" id="<?= $arItemIDs["ID"] ?>">
		<div class="bxr-element-container">
			...
			<div class="bxr-element-image">
				...
				?>
				<a rel="nofollow" rel="nofollow" href="<?= $arElement["DETAIL_PAGE_URL"] ?>">

					<? if ($arElementParams['SIMPLE_TEMPLATE'] === 'Y'): ?>
						<img alt="<?= $alt ?>" title="<?= $title ?>" src="<?= $picture["src"] ?>"
							 id="<?= $arItemIDs['PICT'] ?>">
					<? else: ?>
						<img v-bx-lazyload
			...
			<div class="bxr-element-name" id="bxr-element-name-<?= $arElement["ID"] ?>">
				<a rel="nofollow" rel="nofollow" href="<?= $arElement["DETAIL_PAGE_URL"] ?>"
				   id="<?= $arItemIDs["ID"] ?>" title="<?= $arElement["NAME"] ?>">
