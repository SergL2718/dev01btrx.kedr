...
if (is_array($arElement["OFFERS"]))
    foreach ($arElement["OFFERS"] as $offer):?>
        <div class="bxr-offer-price-wrap" id="bxr-offer-price-<?= $offer["ID"] ?>" data-item="<?= $offer["ID"] ?>"
             style="display: none;">
            ...
            <div class="bxr-market-item-price bxr-format-price">
                ...
                if ($boolDiscountShow && $arPrice['VALUE'] != $offerDiscountValue) { ?>
                    <span class="bxr-market-old-price"
                          id="<? echo $arItemIDs['PRICE'] . '_' . $offer['ID'] . '_offer_old'; ?>"><?= $arPrice['PRINT_VALUE'] ?></span>
                    <br>
                <?
                }
                //--current price with all discounts--
                ?><span class="bxr-market-current-price bxr-market-format-price"
                        id="<? echo $arItemIDs['PRICE'] . '_' . $offer['ID'] . '_offer'; ?>"><?= CurrencyFormat($arPrice['DISCOUNT_VALUE'], $arPrice["CURRENCY"]) ?></span>
                <div class="clearfix"></div>
            </div>
            <div class="clearfix"></div>
        </div>
