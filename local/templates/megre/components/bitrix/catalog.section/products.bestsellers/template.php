...
?>
<div class="mt-5 mb-4">
    <div class="swiper slider-bestseller swiper-arrow-center swiper-arrow-center_up">
    ...
    <script>
		const swiperBestseller = new Swiper('.slider-bestseller', {
			loop: false,
			navigation: {
				nextEl: '.slider-bestseller .swiper-arrow-next',
				prevEl: '.slider-bestseller .swiper-arrow-prev',
			},
			pagination: {
