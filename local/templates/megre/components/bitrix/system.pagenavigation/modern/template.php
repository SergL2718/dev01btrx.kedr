	...
	if($arResult["bDescPageNumbering"] === true):
		...
		do
		{
			...
			if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):
				?>
                <li class="current"><span class="<?=($bFirst ? "modern-page-first " : "")?>modern-page-current"><?=$NavRecordGroupPrint?></span></li>
			<?
		...
		do
		{
			if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):
				?>
                <li class="current"><span class="<?=($bFirst ? "modern-page-first " : "")?>modern-page-current"><?=$arResult["nStartPage"]?></span></li>
			<?
