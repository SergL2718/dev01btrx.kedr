...
?>
    <div class="catalog-filter">
            ...
            <div class="bx-filter <?= $templateData["TEMPLATE_CLASS"] ?> <? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal" ?>">
                <div class="bx-filter-section container-fluid">
                    ...
                    <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>"
                          action="<? echo $arResult["FORM_ACTION"] ?>" method="get" class="smartfilter">
                            ...
                            <? /*foreach($arResult["ITEMS"] as $key=>$arItem)//prices
						{
							...
							$arResult["FORM_ACTION_ROOT"] = str_replace("filter/clear/apply/","",$arResult["JS_FILTER_PARAMS"]["SEF_DEL_FILTER_URL"]);
                            ?>
                            <div class="catalog-filter__card" data-href="<?=$arResult["FORM_ACTION_ROOT"]?>">
                                ...
                                <div class="catalog-filter__card-content">
                                    <div class="catalog-filter__card-content-inner">
                                        ...
                                        <div class="catalog-filter__row">
                                            <a class="catalog-filter__link" href="<?=$arResult["FORM_ACTION_ROOT"]?>filter/newproduct-is-c5ebabc6-82cf-4fc4-adea-5056db223a20/apply/">Новинки</a>
                                        </div>
                                        <div class="catalog-filter__row"><a class="catalog-filter__link" href="<?=$arResult["FORM_ACTION_ROOT"]?>filter/specialoffer-is-c5ebabc6-82cf-4fc4-adea-5056db223a20/apply/">Скидки</a>
                                        </div>
                                        <div class="catalog-filter__row">
                                            <a class="catalog-filter__link" href="<?=$arResult["FORM_ACTION_ROOT"]?>filter/saleleader-is-c5ebabc6-82cf-4fc4-adea-5056db223a20/apply/">Бестселлеры</a></div>
                                    </div>
                                </div>
                            </div>
                            <??>
                            <?
                                ...
                                foreach ($arResult["ITEMS"] as $key => $arItem) {
                                    ...
                                    if($arItem["CODE"]=="VID_MASLA" || $arItem["CODE"]=="SALELEADER" || $arItem["CODE"]=="NEWPRODUCT" || $arItem["CODE"]=="RECOMMENDED"|| $arItem["CODE"]=="SPECIALOFFER")continue;
                                    ?>
                                    <div class="prop_<?=$arItem["CODE"]?> <? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?>col-sm-6 col-md-4<? else: ?>col-lg-12<? endif ?> bx-filter-parameters-box <? if ($arItem["DISPLAY_EXPANDED"] == "Y"): ?>bx-active<? endif ?>">
                                        <span class="bx-filter-container-modef"></span>
							...
							<span class="bx-filter-parameters-box-hint"><?= $arItem["NAME"] ?>
                                ...
                                ?>
                                    <div class="<? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?>col-sm-6 col-md-4<? else: ?>col-lg-12<? endif ?> bx-filter-parameters-box bx-active">
                                        <span class="bx-filter-container-modef"></span>
                                        <div class="bx-filter-parameters-box-title"
                                             onclick="smartFilter.hideFilterProps(this)"><span><?= $arItem["NAME"] ?> <i
                                                ...
                                                <div class="col-xs-6 bx-filter-parameters-box-container-block bx-left">
                                                    ...
                                                    <div class="bx-filter-input-container">
                                                        <input
                                                            ...
                                                            size="5"
                                                            onkeyup="smartFilter.keyup(this)"
                                                            placeholder="<? echo $arItem["VALUES"]["MIN"]["VALUE"] ?> р."
                                                        />
                                                    </div>
                                                </div>
                                                <div class="col-xs-6 bx-filter-parameters-box-container-block bx-right">
                                                    ...
                                                    <div class="bx-filter-input-container">
                                                        <input
                                                            ...
                                                            size="5"
                                                            onkeyup="smartFilter.keyup(this)"
                                                            placeholder="<? echo $arItem["VALUES"]["MAX"]["VALUE"] ?> р."
                                                        />
                                                    </div>
                                                </div>
                            ...
                            <div class="col-xs-12 bx-filter-button-box">
                                <div class="bx-filter-block">
                                    <div class="bx-filter-parameters-box-container">
                                        <input
                                            class="btn button button_outline"
                                            type="submit"
                                            id="set_filter"
                                            name="set_filter"
                                        ...
                                        />
                                        <input
                                            class="btn button button_outline-gray"
                                            type="submit"
                                            id="del_filter"
                                            name="del_filter"
        ...
        <div class="catalog-filter__card">
            ...
            <div class="catalog-filter__card-content">
                <div class="catalog-filter__card-content-inner">
                    <div class="catalog-filter__row"><a class="catalog-filter__link" href="#">Все товары</a>
                    </div>



                    <div class="catalog-filter__row drop">
                        <div class="catalog-filter__link">Масла</div>
                        <div class="catalog-filter__drop">
                            <div class="catalog-filter__drop-wrapper">
                                <label class="checkbox">
                                    <input class="checkbox__input" type="checkbox"/><span
                                            class="checkbox__label">Без добавок</span>
                                </label>
                                <label class="checkbox">
                                    <input class="checkbox__input" type="checkbox"/><span
                                            class="checkbox__label">Обогащённое</span>
                                </label>
                                <label class="checkbox">
                                    <input class="checkbox__input" type="checkbox"/><span
                                            class="checkbox__label">Эликсиры</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="catalog-filter__row drop">
                        <div class="catalog-filter__link">Питание</div>
                        <div class="catalog-filter__drop">
                            <div class="catalog-filter__drop-wrapper">
                                <label class="checkbox">
                                    <input class="checkbox__input" type="checkbox"/><span
                    ...
                    <div class="catalog-filter__row drop">
                        <div class="catalog-filter__link">Дом</div>
                        <div class="catalog-filter__drop">
                            <div class="catalog-filter__drop-wrapper">
                                <label class="checkbox">
                                    <input class="checkbox__input" type="checkbox"/><span
                    ...
                    <div class="catalog-filter__row drop">
                        <div class="catalog-filter__link">Книги</div>
                        <div class="catalog-filter__drop">
                            <div class="catalog-filter__drop-wrapper">
                                <label class="checkbox">
                                    <input class="checkbox__input" type="checkbox"/><span
                    ...
                    <div class="catalog-filter__row drop">
                        <div class="catalog-filter__link">Уход</div>
                        <div class="catalog-filter__drop">
                            <div class="catalog-filter__drop-wrapper">
                                <label class="checkbox">
                                    <input class="checkbox__input" type="checkbox"/><span
                    ...
                    <div class="catalog-filter__row"><a class="catalog-filter__link" href="#">Новинки</a>
                    </div>
                    <div class="catalog-filter__row"><a class="catalog-filter__link" href="#">Скидки</a>
                    </div>
                    <div class="catalog-filter__row"><a class="catalog-filter__link"
                                                        href="#">Бестселлеры</a></div>
                </div>
            </div>
        </div>
        <div class="catalog-filter__card drop active">
            <div class="catalog-filter__card-title">ПРОИЗВОДИТЕЛИ</div>
            <div class="catalog-filter__card-content" style="display: block;">
                <div class="catalog-filter__card-content-inner">
                    <div class="catalog-filter__row">
                        <label class="checkbox">
                            <input class="checkbox__input" type="checkbox"/><span class="checkbox__label">ООО “Мегре”</span>
                        </label>
                    </div>
                    <div class="catalog-filter__row">
                        <label class="checkbox">
                            <input class="checkbox__input" type="checkbox"/><span class="checkbox__label">Название</span>
                        </label>
                    </div>
                    <div class="catalog-filter__row">
                        <label class="checkbox">
                ...
                <div class="catalog-filter__card-content-more">Показать всё&nbsp;&nbsp;&nbsp;<b>+</b></div>
            </div>
        </div>
        <div class="catalog-filter__card drop active">
            <div class="catalog-filter__card-title">ЦЕНА</div>
            <div class="catalog-filter__card-content" style="display: block;">
                <div class="catalog-filter__card-content-inner">
                    <div class="catalog-filter__row">
                        <div class="range-slider-container">
                            <div class="range-slider-number">
                                <div class="range-slider-number-1"><span></span>&nbsp;р.</div>
                                <div class="range-slider-number-2"><span></span>&nbsp;р.</div>
                            </div>
        ...
        <div class="catalog-filter__reset">
            <div class="button button_outline-gray">Сбросить фильтры</div>
        </div>
<?*/ ?>
