...
$defaultValue = ['-' => GetMessage('CP_BC_TPL_PROP_EMPTY')];
...
if (isset($arCurrentValues['SECTIONS_VIEW_MODE']) && 'TILE' == $arCurrentValues['SECTIONS_VIEW_MODE']) {
	$arTemplateParameters['SECTIONS_HIDE_SECTION_NAME'] = [
		'PARENT'  => 'SECTIONS_SETTINGS',
...
$arTemplateParameters["FILTER_VIEW_MODE"] = [
...
$arTemplateParameters["FILTER_HIDE_ON_MOBILE"] = [
	"PARENT"  => "FILTER_SETTINGS",
...
$arTemplateParameters["INSTANT_RELOAD"] = [
	"PARENT"  => "FILTER_SETTINGS",
...
$arTemplateParameters['SEARCH_PAGE_RESULT_COUNT'] = [
	'PARENT'  => 'SEARCH_SETTINGS',
	'NAME'    => GetMessage("CP_BC_TPL_SEARCH_PAGE_RESULT_COUNT"),
	"TYPE"    => "STRING",
	"DEFAULT" => "50",
];
$arTemplateParameters['SEARCH_RESTART'] = [
	'PARENT'  => 'SEARCH_SETTINGS',
	'NAME'    => GetMessage("CP_BC_TPL_SEARCH_RESTART"),
	"TYPE"    => "CHECKBOX",
	"DEFAULT" => "N",
];
$arTemplateParameters['SEARCH_NO_WORD_LOGIC'] = [
	'PARENT'  => 'SEARCH_SETTINGS',
	'NAME'    => GetMessage("CP_BC_TPL_SEARCH_NO_WORD_LOGIC"),
	"TYPE"    => "CHECKBOX",
	"DEFAULT" => "Y",
];
$arTemplateParameters['SEARCH_USE_LANGUAGE_GUESS'] = [
	'PARENT'  => 'SEARCH_SETTINGS',
	'NAME'    => GetMessage("CP_BC_TPL_SEARCH_USE_LANGUAGE_GUESS"),
	"TYPE"    => "CHECKBOX",
	"DEFAULT" => "Y",
];
$arTemplateParameters['SEARCH_CHECK_DATES'] = [
	'PARENT'  => 'SEARCH_SETTINGS',
	'NAME'    => GetMessage("CP_BC_TPL_SEARCH_CHECK_DATES"),
	"TYPE"    => "CHECKBOX",
	"DEFAULT" => "Y",
];
$arTemplateParameters['SEARCH_USE_SEARCH_RESULT_ORDER'] = [
	'PARENT'  => 'SEARCH_SETTINGS',
...
if ($iblockExists) {
	...
	if (!empty($showedProperties)) {
		...
		$arTemplateParameters['LIST_PROPERTY_CODE_MOBILE'] = [
	...
	$arTemplateParameters['LIST_PRODUCT_BLOCKS_ORDER'] = [
		'PARENT'   => 'LIST_SETTINGS',
	...
	$arTemplateParameters['LIST_PRODUCT_ROW_VARIANTS'] = [
		'PARENT'           => 'LIST_SETTINGS',
	...
	$arTemplateParameters['LIST_ENLARGE_PRODUCT'] = [
		'PARENT'            => 'LIST_SETTINGS',
	...
	if (isset($arCurrentValues['LIST_ENLARGE_PRODUCT']) && $arCurrentValues['LIST_ENLARGE_PRODUCT'] === 'PROP') {
		$arTemplateParameters['LIST_ENLARGE_PROP'] = [
			'PARENT'            => 'LIST_SETTINGS',
	...
	$arTemplateParameters['LIST_SHOW_SLIDER'] = [
		'PARENT'   => 'LIST_SETTINGS',
	...
	if (!isset($arCurrentValues['LIST_SHOW_SLIDER']) || $arCurrentValues['LIST_SHOW_SLIDER'] === 'Y') {
		$arTemplateParameters['LIST_SLIDER_INTERVAL'] = [
			'PARENT'   => 'LIST_SETTINGS',
		...
		$arTemplateParameters['LIST_SLIDER_PROGRESS'] = [
			'PARENT'   => 'LIST_SETTINGS',
	...
	if (!empty($showedProperties)) {
		...
		$arTemplateParameters['DETAIL_MAIN_BLOCK_PROPERTY_CODE'] = [
...
if ($boolSKU) {
	...
	if (!empty($showedProperties)) {
		...
		$arTemplateParameters['DETAIL_MAIN_BLOCK_OFFERS_PROPERTY_CODE'] = [
			'PARENT'   => 'DETAIL_SETTINGS',
...
$arTemplateParameters['DETAIL_USE_VOTE_RATING'] = [
	'PARENT'  => 'DETAIL_SETTINGS',
...
if (isset($arCurrentValues['DETAIL_USE_VOTE_RATING']) && 'Y' == $arCurrentValues['DETAIL_USE_VOTE_RATING']) {
	$arTemplateParameters['DETAIL_VOTE_DISPLAY_AS_RATING'] = [
		'PARENT'  => 'DETAIL_SETTINGS',
...
if (isset($arCurrentValues['DETAIL_USE_COMMENTS']) && 'Y' == $arCurrentValues['DETAIL_USE_COMMENTS']) {
	...
	$boolRus = false;
	$rsLangs = CLanguage::GetList('id', 'asc', ['ID' => 'ru', "ACTIVE" => "Y"]);
...
if (ModuleManager::isModuleInstalled("highloadblock")) {
	$arTemplateParameters['DETAIL_BRAND_USE'] = [
		'PARENT'  => 'DETAIL_SETTINGS',
	...
	if (isset($arCurrentValues['DETAIL_BRAND_USE']) && 'Y' == $arCurrentValues['DETAIL_BRAND_USE']) {
		$arTemplateParameters['DETAIL_BRAND_PROP_CODE'] = [
			'PARENT'            => 'DETAIL_SETTINGS',
...
$arTemplateParameters['DETAIL_DISPLAY_NAME'] = [
	'PARENT'  => 'DETAIL_SETTINGS',
	'NAME'    => GetMessage('CP_BC_TPL_DETAIL_DISPLAY_NAME'),
	'TYPE'    => 'CHECKBOX',
	'DEFAULT' => 'Y',
];
$arTemplateParameters['DETAIL_IMAGE_RESOLUTION'] = [
	'PARENT'  => 'DETAIL_SETTINGS',
...
$arTemplateParameters['DETAIL_PRODUCT_INFO_BLOCK_ORDER'] = [
	'PARENT'   => 'DETAIL_SETTINGS',
...
$arTemplateParameters['DETAIL_PRODUCT_PAY_BLOCK_ORDER'] = [
	'PARENT'   => 'DETAIL_SETTINGS',
...
$arTemplateParameters['DETAIL_SHOW_SLIDER'] = [
	'PARENT'   => 'DETAIL_SETTINGS',
...
if (isset($arCurrentValues['DETAIL_SHOW_SLIDER']) && $arCurrentValues['DETAIL_SHOW_SLIDER'] === 'Y') {
	$arTemplateParameters['DETAIL_SLIDER_INTERVAL'] = [
		'PARENT'   => 'DETAIL_SETTINGS',
	...
	$arTemplateParameters['DETAIL_SLIDER_PROGRESS'] = [
		'PARENT'   => 'DETAIL_SETTINGS',
...
$arTemplateParameters['DETAIL_DETAIL_PICTURE_MODE'] = [
	'PARENT'   => 'DETAIL_SETTINGS',
...
$arTemplateParameters['DETAIL_ADD_DETAIL_TO_SLIDER'] = [
	'PARENT'  => 'DETAIL_SETTINGS',
	'NAME'    => GetMessage('CP_BC_TPL_DETAIL_ADD_DETAIL_TO_SLIDER'),
	'TYPE'    => 'CHECKBOX',
	'DEFAULT' => 'N',
];
$arTemplateParameters['DETAIL_DISPLAY_PREVIEW_TEXT_MODE'] = [
	'PARENT'  => 'DETAIL_SETTINGS',
...
if ($boolCatalog) {
	$arTemplateParameters['USE_COMMON_SETTINGS_BASKET_POPUP'] = [
		'PARENT'  => 'BASKET',
	...
	$arTemplateParameters['COMMON_ADD_TO_BASKET_ACTION'] = [
		'PARENT'  => 'BASKET',
	...
	$arTemplateParameters['COMMON_SHOW_CLOSE_POPUP'] = [
		'PARENT'  => 'VISUAL',
	...
	$arTemplateParameters['TOP_ADD_TO_BASKET_ACTION'] = [
		'PARENT'  => 'BASKET',
	...
	$arTemplateParameters['SECTION_ADD_TO_BASKET_ACTION'] = [
		'PARENT'  => 'BASKET',
	...
	$arTemplateParameters['DETAIL_ADD_TO_BASKET_ACTION'] = [
		'PARENT'   => 'BASKET',
	...
	if (!$useCommonSettingsBasketPopup && !empty($arCurrentValues['DETAIL_ADD_TO_BASKET_ACTION'])) {
		...
		if (!is_array($arCurrentValues['DETAIL_ADD_TO_BASKET_ACTION'])) {
			$arCurrentValues['DETAIL_ADD_TO_BASKET_ACTION'] = [$arCurrentValues['DETAIL_ADD_TO_BASKET_ACTION']];
		}
		...
		$arTemplateParameters['DETAIL_ADD_TO_BASKET_ACTION_PRIMARY'] = [
			'PARENT'   => 'BASKET',
...
if (ModuleManager::isModuleInstalled("sale")) {
	$arTemplateParameters['USE_SALE_BESTSELLERS'] = [
		'NAME'    => GetMessage('CP_BC_TPL_USE_SALE_BESTSELLERS'),
		'TYPE'    => 'CHECKBOX',
		'DEFAULT' => 'Y',
	];

	$arTemplateParameters['USE_BIG_DATA'] = [
	...
	if (!isset($arCurrentValues['USE_BIG_DATA']) || $arCurrentValues['USE_BIG_DATA'] == 'Y') {
		...
		$arTemplateParameters['BIG_DATA_RCM_TYPE'] = [
			'PARENT'  => 'BIG_DATA_SETTINGS',
...
if (isset($arCurrentValues['SHOW_TOP_ELEMENTS']) && 'Y' == $arCurrentValues['SHOW_TOP_ELEMENTS']) {
	$arTemplateParameters['TOP_VIEW_MODE'] = [
		'PARENT'   => 'TOP_SETTINGS',
	...
	if (isset($arCurrentValues['TOP_VIEW_MODE']) && ('SLIDER' == $arCurrentValues['TOP_VIEW_MODE'] || 'BANNER' == $arCurrentValues['TOP_VIEW_MODE'])) {
		$arTemplateParameters['TOP_ROTATE_TIMER'] = [
			'PARENT'  => 'TOP_SETTINGS',
	...
	if (isset($arCurrentValues['TOP_VIEW_MODE']) && $arCurrentValues['TOP_VIEW_MODE'] === 'SECTION') {
		if (!empty($arCurrentValues['TOP_PROPERTY_CODE'])) {
			...
			$arTemplateParameters['TOP_PROPERTY_CODE_MOBILE'] = [
				'PARENT'   => 'TOP_SETTINGS',
				'NAME'     => GetMessage('CP_BC_TPL_PROPERTY_CODE_MOBILE'),
				'TYPE'     => 'LIST',
				'MULTIPLE' => 'Y',
		...
		$arTemplateParameters['TOP_PRODUCT_BLOCKS_ORDER'] = [
			'PARENT'   => 'TOP_SETTINGS',
			'NAME'     => GetMessage('CP_BC_TPL_PRODUCT_BLOCKS_ORDER'),
			'TYPE'     => 'CUSTOM',
		...
		$arTemplateParameters['TOP_PRODUCT_ROW_VARIANTS'] = [
			'PARENT'           => 'TOP_SETTINGS',
			'NAME'             => GetMessage('CP_BC_TPL_PRODUCT_ROW_VARIANTS'),
			'TYPE'             => 'CUSTOM',
			'BIG_DATA'         => 'N',
		...
		$arTemplateParameters['TOP_ENLARGE_PRODUCT'] = [
			'PARENT'            => 'TOP_SETTINGS',
			'NAME'              => GetMessage('CP_BC_TPL_ENLARGE_PRODUCT'),
			'TYPE'              => 'LIST',
			'MULTIPLE'          => 'N',
		...
		if (isset($arCurrentValues['TOP_ENLARGE_PRODUCT']) && $arCurrentValues['TOP_ENLARGE_PRODUCT'] === 'PROP') {
			$arTemplateParameters['TOP_ENLARGE_PROP'] = [
				'PARENT'            => 'TOP_SETTINGS',
				'NAME'              => GetMessage('CP_BC_TPL_ENLARGE_PROP'),
				'TYPE'              => 'LIST',
				'MULTIPLE'          => 'N',
		...
		$arTemplateParameters['TOP_SHOW_SLIDER'] = [
			'PARENT'   => 'TOP_SETTINGS',
			'NAME'     => GetMessage('CP_BC_TPL_SHOW_SLIDER'),
			'TYPE'     => 'CHECKBOX',
			'MULTIPLE' => 'N',
		...
		if (!isset($arCurrentValues['TOP_SHOW_SLIDER']) || $arCurrentValues['TOP_SHOW_SLIDER'] === 'Y') {
			$arTemplateParameters['TOP_SLIDER_INTERVAL'] = [
				'PARENT'   => 'TOP_SETTINGS',
				'NAME'     => GetMessage('CP_BC_TPL_SLIDER_INTERVAL'),
				'TYPE'     => 'TEXT',
				'MULTIPLE' => 'N',
			...
			$arTemplateParameters['TOP_SLIDER_PROGRESS'] = [
				'PARENT'   => 'TOP_SETTINGS',
				'NAME'     => GetMessage('CP_BC_TPL_SLIDER_PROGRESS'),
				'TYPE'     => 'CHECKBOX',
				'MULTIPLE' => 'N',
...
if (isset($arCurrentValues['USE_COMPARE']) && $arCurrentValues['USE_COMPARE'] == 'Y') {
	$arTemplateParameters['COMPARE_POSITION_FIXED'] = [
	...
	if (!isset($arCurrentValues['COMPARE_POSITION_FIXED']) || $arCurrentValues['COMPARE_POSITION_FIXED'] == 'Y') {
		...
		$arTemplateParameters['COMPARE_POSITION'] = [
			'PARENT'  => 'COMPARE_SETTINGS',
...
$arTemplateParameters['DETAIL_SHOW_POPULAR'] = [
	'PARENT'  => 'DETAIL_SETTINGS',
	'NAME'    => GetMessage('CP_BC_TPL_DETAIL_SHOW_POPULAR'),
	'TYPE'    => 'CHECKBOX',
	'DEFAULT' => 'Y',
];
$arTemplateParameters['DETAIL_SHOW_VIEWED'] = [
	'PARENT'  => 'DETAIL_SETTINGS',
...
$arTemplateParameters['HIDE_USE_ALSO_BUY'] = [];