        ...
        <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
                ...
                if (isset($arItem["PRICE"])):
                    ...
                    <div class="bx_filter_parameters_box active">
                        ...
                        <div class="bx_filter_parameters_box_title" onclick="smartFilter.hideFilterProps(this)"
                             data-role="prop_angle"><?= $arItem["NAME"] ?></div>
                        <div class="bx_filter_block" data-role="bx_filter_block">
                            <div class="bx_filter_parameters_box_container">
                                ...
                                <div class="bx_ui_slider_track" id="drag_track_<?= $key ?>">
                                    ...
                                    <div class="bx_ui_slider_pricebar_V bx_ui_slider_range" style="left: 0;right: 0;"
            ...
            foreach ($arResult["ITEMS"] as $key => $arItem) {
                ...
                if ($arItem["DISPLAY_EXPANDED"] == "Y"):?>active<? endif ?>">
                    <span class="bx_filter_container_modef"></span>
                    <div class="bx_filter_parameters_box_title" data-role="prop_angle"
            ...
            <div class="bx_filter_button_box active">
                <div class="bx_filter_block">
                    <div class="bx_filter_parameters_box_container">
                        <input class="bxr-color-button" type="submit" id="set_filter" name="set_filter"
                        ...
                        <div class="bx_filter_popup_result right"
                            ...
                            <noindex><a class="bxr-color-button bxr-color-button-small" rel="nofollow"
                                        href="<? echo $arResult["FILTER_URL"] ?>"><? echo GetMessage("CT_BCSF_FILTER_SHOW") ?></a>
                            </noindex>
                        </div>
                    </div>
                </div>
