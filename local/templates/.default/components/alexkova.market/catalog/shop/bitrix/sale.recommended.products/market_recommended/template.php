...
if (count($arResult['ITEMS']) > 0) {
    ...
    <div class="row bxr-list" id="product-list-recommended">
        ...
        foreach ($arResult["ITEMS"] as $key => $arItem) {
            ...
            <div id="<?= $strMainID ?>"
                 class="t_<?= $unicumID ?> col-lg-<?= $arResponsiveParams["LG"] ?> col-md-<?= $arResponsiveParams["MD"] ?> col-sm-<?= $arResponsiveParams["SM"] ?> col-xs-<?= $arResponsiveParams["XS"] ?>">
                <?
