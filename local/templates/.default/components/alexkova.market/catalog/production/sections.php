    ...
    <? if (isset($arParams["SHOW_LEFT_MENU"]) && $arParams["SHOW_LEFT_MENU"] == "Y"): ?>
        ...
        $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "MAX_LEVEL" => isset($arParams["MAX_LEVEL"]) ? $arParams["MAX_LEVEL"] : "3",
...
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
    ...
    <div class="section-description">
        ...
        <p>
            На продукции, которую можно купить в интернет-магазине с доставкой в любую точку России, расположена
            кнопка<span class="btn-buy-shop">Купить в магазине</span> Нажав на нее, Вы перейдете в интернет-магазин <a
                    href="/" rel="nofollow">megre.ru</a> для оформления заказа.
        </p>
        <p>
            На продукци, которая продается только в фирменных отделах, расположена кнопка<span class="btn-buy-dealer">Купить у дилера</span>
            Нажав на нее, Вы сможете увидеть <a href="/dealers/">адреса торговых точек</a>, где может быть доступен товар.
            <br>ВНИМАНИЕ: свяжитесь с нужным Вам отделом, чтобы уточнить наличие интересующей позиции или сделать заказ.
        </p>
    </div>
    <!--/noindex-->
    <? $APPLICATION->IncludeComponent(
