...
<div id="bxr-basket-row" class="basket-body-table-row bxr-basket-row-top">
    <div class="">
        <? // Basket can by Info?>
        <a href="/personal/basket/" class="bxr-basket-indicator bxr-indicator-basket bxr-font-hover-light"
...
<?
    ...
    <div id="bxr-indicator-basket-new"><?
        include('basket_delay_state.php'); ?></div>
    <div id="bxr-indicator-delay-new"><?
        include('delay_state.php'); ?></div>
    <div id="bxr-indicator-favor-new"><?
        include('favor_state.php'); ?></div>
    <?
    die();
endif;
?>
