    ...
    window.BXReady.Market.Basket = {
            ...
            if (!notAllProp) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // Отключаем попап
                        // https://megre.bitrix24.ru/workgroups/group/9/tasks/task/view/11317/
        ...
        deleteItem: function (item) {
            ...
            $.ajax({
                url: basket.ajaxUrl + '?' + data,
                success: function (data) {
                    let btn = document.querySelector('.icon-button-delete[data-item="' + item + '"]');
                    let productId = btn.dataset.productId;
                    let productName = btn.dataset.productName.replace('&quot;','').replace('"','');
                    let price = btn.dataset.productBasePrice;
                    let quantity = document.querySelector('input[name="quantity"][data-item="' + item + '"]');
