								...
								<div class="bx-soa-pp-company col-lg-3 col-sm-4 col-xs-6">
									<div class="bx-soa-pp-company-graf-container">
										...
										<div class="bx-soa-pp-company-image"
											 style="
											 		background-image: url(/upload/sale/paysystem/logotip/5b8/5b8538f5ec25775365aa346a10547adb.gif); /*�������� �� ��������� 150px �������*/
											 		background-image: -webkit-image-set(url(150px.jpg) 1x, url(230px.jpg) 2x); /*�������� ��� �������� 150px ��� ������ 300px*/

											 		"></div>
									</div>
									<div class="bx-soa-pp-company-smalltitle">������.������</div>
								</div>
								<div class="bx-soa-pp-company col-lg-3 col-sm-4 col-xs-6">
									<div class="bx-soa-pp-company-graf-container">
										<input id=""
