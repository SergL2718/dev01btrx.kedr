<?
/**
 * Copyright (c) 2018 Denis Artamonov
 * Created: 12/25/18 2:55 PM
...
<div class="bx-authform-social">
    ...
    <div style=" font-weight: bold; margin-bottom: 5px;margin-top: 25px;">
        ...
        foreach ($arAuthServices as $service):
            ...
            <li>
                <a id="bx_socserv_icon_<?= $service["ID"] ?>"
                   ...
                   title="<?= \Bitrix\Main\Text\HtmlFilter::encode($service["NAME"]) ?>"></a>
                <?
