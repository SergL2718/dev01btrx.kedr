...
/*
 * Изменено: 24 April 2018, Tuesday
        ...
        <div class="bxr-sender-subscribe-container column container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 bxr_subscribe_submit_container">
                    <button id="bxr_subscribe_btn_<?= $buttonId ?>" data-id="confirm-subscribe-sidebar"
                            class="bxr-color-button" value="79"
                            tabindex="0"><?= GetMessage("subscr_form_button") ?></button>
                </div>
                <div class="col-md-12">
                    <div class="confirm-subscribe">
                        <input type="checkbox" id="confirm-subscribe-sidebar" name="confirm-subscribe-sidebar"
                               checked>
                        <label for="confirm-subscribe-sidebar">
                            Нажимая кнопку «<?= GetMessage("subscr_form_button") ?>», я даю свое согласие на
