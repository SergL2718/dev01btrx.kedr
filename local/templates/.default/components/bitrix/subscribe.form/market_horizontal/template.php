...
<div class="bxr-subscribe" id="sender-subscribe">
    ...
    <form role="form" method="post" action="<?= $arResult["FORM_ACTION"] ?>">
        ...
        <div class="bxr-sender-subscribe-container horizontal container-fluid">
            <div class="row">
                <div class="col-md-5 bxr-subscribe-motto">
                ...
                <!--<div class="col-md-3 bxr-subscribe-rubrics">
                    <? /* if (isset($arParams["SHOW_RUBRICS"]) && $arParams["SHOW_RUBRICS"] == "Y"): */ ?>
                        ...
                        <? /* endif; */ ?>
                        <div class="bxr_subscribe_checkbox_container">
                            <ul>
                ...
                <div class="col-md-5 bxr-input-group">
                    <input class="bxr-form-control" type="email" name="SENDER_SUBSCRIBE_EMAIL"
                ...
                <div class="col-md-2 bxr_subscribe_submit_container">
                    <button id="bxr_subscribe_btn_<?= $buttonId ?>" data-id="confirm-subscribe-main-page"
                            class="bxr-color-button" value="79"
                            tabindex="0"><?= GetMessage("subscr_form_button") ?></button>
                </div>
                <div class="col-md-12">
                    <div class="confirm-subscribe">
                        <input type="checkbox" id="confirm-subscribe-main-page" name="confirm-subscribe-main-page"
                               checked>
                        <label for="confirm-subscribe-main-page">
                            Нажимая кнопку «<?= GetMessage("subscr_form_button") ?>», я даю свое согласие на обработку
        ...
        <div class="bxr-sender-subscribe-container horizontal container-fluid">
            <div class="row">
                ...
                <div class="col-md-3 bxr-input-group">
                    <input class="bxr-form-control" type="email" name="SENDER_SUBSCRIBE_EMAIL" value=""
                           title="<?= GetMessage("subscr_form_email_title") ?>"
                           placeholder="<?= htmlspecialcharsbx(GetMessage('subscr_form_email_title')) ?>">
                </div>
                <div class="col-md-2 bxr_subscribe_submit_container">
                    <button id="bxr_subscribe_btn_<?= $buttonId ?>" class="bxr-color-button" value="79"
                            tabindex="0"><?= GetMessage("subscr_form_button") ?></button>
                </div>
            </div>
        </div>
