    ...
    foreach ($arResult['ITEMS'] as $key => $arItem) {
        ...
        if ($arItem['CATALOG'] && isset($arItem['OFFERS']) && !empty($arItem['OFFERS'])) {
            ...
            if ('Y' == $arParams['PRODUCT_DISPLAY_MODE']) {
                ...
                unset($keyOffer, $arOffer, $arOfferIds, $accessOfferList);
...
//					$arItem['PREVIEW_PICTURE'] = $arMatrix[$intSelected]['PREVIEW_PICTURE'];
    ...
    if (!empty($arIds)) {
        $arSectionBasketProps = Alexkova\Market\Basket::getSectionsBasketProps(array_keys($arIds), $arParams["IBLOCK_ID"]);
