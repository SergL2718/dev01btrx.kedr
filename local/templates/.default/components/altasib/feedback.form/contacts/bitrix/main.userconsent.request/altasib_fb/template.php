...
$arParams['REPLACE']['INPUT_LABEL'] = trim($arParams['REPLACE']['INPUT_LABEL']) != "" ? (string) $arParams['REPLACE']['INPUT_LABEL'] : htmlspecialcharsbx($arResult['INPUT_LABEL']);
?>
<label data-bx-user-consent="<?= htmlspecialcharsbx($config) ?>" class="main-user-consent-request">
	...
	<a><?= $arParams['REPLACE']['INPUT_LABEL'] ?></a>
</label>
			...
			<div class="main-user-consent-request-popup-body">
				<div data-bx-loader="" class="main-user-consent-request-loader">
					<svg class="main-user-consent-request-circular" viewBox="25 25 50 50">
						<circle class="main-user-consent-request-path"
								cx="50"
								cy="50"
								r="20"
								fill="none"
