...
$APPLICATION->SetPageProperty('description', 'Новости компании «Звенящие Кедры», открытие отделов в России и других странах, новинки, события, открытия и полезная информация... Нам есть, чем поделиться.');
